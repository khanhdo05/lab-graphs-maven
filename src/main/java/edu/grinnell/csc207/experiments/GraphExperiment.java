...
public class GraphExperiment {
  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      g.addEdge("f", "f", 0);
      pen.println("Surprisingly, added an edge from f to f");
    } catch (Exception e) {
      pen.println("Correctly failed to add an edge from f to f.");
    } // try/catch
    
    g.dumpWithNames(pen);
    pen.println("Reachable from:");
    g.reachableFrom(pen, (int) 'z');
